...
import '';
import SignSpeakImage from '../images/1.png';
import ShortImage from '../images/short.png';
import AltumcodeImage from '../images/2.jpg';
    ...
    return (
        <div>
            <section className="home" id="#">
                <div className="logo">
                    <img src={SignSpeakImage} width="850" height="900" />;
                </div>

                <div className="shortlogo">
                    <img src={ShortImage} width="250" height="250" />;
                </div>
            ...
            <section id="about" className="about-wallpaper">
                <div className="about-picture">
                    <img src={AltumcodeImage} width="490" height="570" />;
                </div>
                <div className = "text">
                ...
                <a className="buttons" href="" target="_blank">
